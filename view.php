...
$url_base=array('c' => $courseid,'id'=>$instancia,"g"=>$grupo,"m"=>$mes,"y"=>$year,"cc"=>$curso,"f"=>$fecha->format('Y-m-d'),"u"=>$usuario,"ff"=>$fecha_fin->format('Y-m-d'));
$url_tabla = new moodle_url('/blocks/control_sesion/view.php',	array_merge($url_base,array('u' => 0,'t' => 0,'a' => true,"d"=>false)));
$url_usuario = new moodle_url('/blocks/control_sesion/view.php', array_merge($url_base,array('u' => $usuario,'t' => 1,'a' => true,"d"=>false)));
$url_semanal = new moodle_url('/blocks/control_sesion/view.php', array_merge($url_base,array('u' => $usuario,'t' => 2,'a' => true,"d"=>false)));
$url_mensual = new moodle_url('/blocks/control_sesion/view.php', array_merge($url_base,array('u' => 0,'t' => 3,'a' => true,"d"=>false)));
$url_anual = new moodle_url('/blocks/control_sesion/view.php', array_merge($url_base,array('u' => 0,'t' => 4,'a' => true,"d"=>false)));
$url_detalle_mes = new moodle_url('/blocks/control_sesion/view.php', array_merge($url_base,array('u' => $usuario,'t' => 5,'a' => true,"d"=>false)));
$url_descarga = new moodle_url('/blocks/control_sesion/view.php', array_merge($url_base,array('u' => 0,'t' => $tipo_tabla,"d"=>true)));
echo $OUTPUT->header();
